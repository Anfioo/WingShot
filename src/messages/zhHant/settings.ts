export const settings = {
	...
	"settings.renderBackend.tip":
		"切換後下次截圖生效。若目前環境不支援 WebGPU，將自動回退到 WebGL",
	...
	"settings.systemSettings.commonSettings.runLog.tip":
		"將記錄輸出到記錄檔案中，用於問題回報",
	"settings.systemSettings.commonSettings.logRetentionDuration": "日誌保留時長",
	...
	"settings.systemSettings.screenshotSettings.captureMethod": "擷取方式",
	...
	"settings.systemSettings.screenshotSettings.hdrColorCorrection.off": "關閉",
