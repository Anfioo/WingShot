...
export const defaultAppSettingsData: AppSettingsData = {
	...
	[AppSettingsGroup.SystemCommon]: {
		...
		logRetentionDuration: LogRetentionDuration.Week,
...
4. Visual structure preservation`,
	...
	[AppSettingsGroup.FunctionOutput]: {
		...
		autoSaveFileNameFormat: `WingShot_{{YYYY-MM-DD_HH-mm-ss}}`,
		fastSaveFileNameFormat: `WingShot_{{YYYY-MM-DD_HH-mm-ss}}`,
		focusedWindowFileNameFormat: `${FOCUS_WINDOW_APP_NAME_ENV_VARIABLE}/WingShot_{{YYYY-MM-DD_HH-mm-ss}}`,
		fullScreenFileNameFormat: `WingShot_{{YYYY-MM-DD_HH-mm-ss}}`,
		videoRecordFileNameFormat: `WingShot_Video_{{YYYY-MM-DD_HH-mm-ss}}`,
		uploadToCloudSaveUrlFormat: `WingShot_{{YYYY-MM-DD_HH-mm-ss}}`,
	},
